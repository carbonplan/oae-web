...
const Intro = () => {
  return (
    <Box sx={{ fontSize: 1, mb: 3 }}>
      ...
      alkalinity enhancement (OAE). Explore global patterns, or drill down to
      see how alkalinity released in a specific region and season will move
      through the ocean and result in carbon removal over time. Read the{' '}
